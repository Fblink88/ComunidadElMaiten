...
import { Check, ShieldOff, Trash2, Search } from "lucide-react"
...
export const AdminUsuariosPage = () => {
    ...
    const [filter, setFilter] = useState<"todos" | "pendientes" | "activos">("todos")
            ...
            <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-6 justify-between items-center">
                    <div className="flex gap-2">
                        ...
                        <Button
                            variant={filter === "pendientes" ? "primary" : "secondary"}
                            onClick={() => setFilter("pendientes")}
                            size="sm"
                            className={filter === "pendientes" ? "bg-yellow-500 hover:bg-yellow-600 border-yellow-500" : ""}
                        >
                            Pendientes
                        </Button>
                        <Button
